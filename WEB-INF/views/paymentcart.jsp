...
<div class="container mt-5">
 ...
 <div align="center" cont">
    ...
    <button class="btn btn-primary continue" onclick="continuenext()"><%= session.getAttribute("qtycost") %></button>
</div>
</div>
<div>
</div>
            ...
            <form id="shipment-form">
                <table>
                    ...
                    <tr>
                        ...
                        <td class="table-col2"><%=request.getAttribute("custspincode") %></td>
                    </tr>
                </table>
            </form>
        </div>
